                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"><a class="nav-link"
                                                    href="../../pages/ui-features/buttons.html">Bảng tổng hợp</a></li>
                            <li class="nav-item"><a class="nav-link" href="../../pages/ui-features/typography.html">Thêm
                                mới</a>
                            </li>
                        </ul>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                    <c:forEach items="${importList}" var="record">
                                        <tr>
                                            <td>${record.getId()}</td>
