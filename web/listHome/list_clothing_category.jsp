...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container-fluid">
        ...
        <ul class="navbar-nav ">
            ...
            <li class="nav-item " style="font-size: 25px; font-weight: bold; color: white">
                <a class="nav-link" href="${pageContext.request.contextPath}/clothing?action=listClothing">
                    <button type=button class="btn">CLOTHING</button>
                </a>
            </li>
            <li class="nav-item " style="font-size: 25px; font-weight: bold; color: white">
                <a class="nav-link" href="${pageContext.request.contextPath}/category?action=listCategory">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-2 text-center text-white">
                <p><u><a href="https://www.drovenger.com/">Drovenger Corporation</a></u> is a
                ...
                <p class="h6">&copy All right Reversed.<a class="text-green ml-2"
                                                          href="https://www.facebook.com/stpdmnky"
                                                          target="_blank">Copyright @ 2020 Drovenger</a></p>
            </div>
        </div>
    </div>
</section>
