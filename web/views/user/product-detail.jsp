                        ...
                        <div class="flex-w flex-r-m p-b-10">
                            <div class="size-204 flex-w flex-m respon6-next">
                                ...
                                <button class="flex-c-m stext-101 cl0 size-101 bg1 bor1 hov-btn1 p-lr-15 trans-04 js-addcart-detail">
                                    <a href="${addtoCart}" style="text-decoration: none; color: white">Thêm vào giỏ
                                        hàng</a>
                                </button>
                            </div>
                        </div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item p-b-10">
                        <a class="nav-link active" data-toggle="tab" href="#description" role="tab"
                           style="font-family: Helvetica, sans-serif">Mô tả sản phẩm</a>
                    </li>

                    <li class="nav-item p-b-10">
                        <a class="nav-link" data-toggle="tab" href="#information" role="tab"
                           style="font-family: Helvetica, sans-serif">Cách chọn size</a>
                    </li>

                    <li class="nav-item p-b-10">
                        <a class="nav-link" data-toggle="tab" href="#reviews" role="tab"
                           style="font-family: Helvetica, sans-serif">Đánh giá sản phẩm (1)</a>
                    </li>
                </ul>
                    ...
                    <div class="tab-pane fade" id="information" role="tabpanel">
                        <div class="row">
                            <div class="col-sm-10 col-md-8 col-lg-6 m-lr-auto">
                                <img src="${pageContext.request.contextPath}/resources/images/page/size-table.jpg"
                                     alt="Lựa chọn size">
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="p-b-30 m-lr-15-sm">
                                    ...
                                    <div class="flex-w flex-t p-b-68">
                                        <div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
                                            <img src="${pageContext.request.contextPath}/resources/images/48a032fddd60273e7e71.jpg"
                                                 alt="AVATAR">
                                        </div>
                                        ...
                                        <div class="size-207">
                                            ...
                                            <p class="stext-102 cl6">
                                                Sản phẩm của shop rất tốt, nhờ đôi giày này mà tôi đã tìm được người đàn
                                                ông đích thực của đời mình,
                                                xin chân thành cảm ơn Drovenger Online Shop.
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <form class="w-full">
                                        ...
                                        <p class="stext-102 cl6">
                                            Email của bạn sẽ luôn được công bố, vì chúng tôi chưa sử lý được cái méo gì
                                            trong vấn dề bảo mật. Các trường đánh dấu * là bắt buộc.
                                        </p>
