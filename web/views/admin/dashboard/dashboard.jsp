                ...
                <ul class="nav">
                        ...
                        <div class="collapse" id="product">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link"
                                                        href="${pageContext.request.contextPath}/product?action=">Danh
                                    sách sản phẩm</a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="bill">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="/admin?action=view_bill">Xem hóa đơn</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="user">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"><a class="nav-link" href="/user?action=view_user">Xem người
                                    dùng</a></li>
                                <li class="nav-item"><a class="nav-link" href="/user?action=create_user">Thêm người
                                    dùng</a></li>
                            </ul>
                        </div>
                    </li>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="aligner-wrapper">
                                        ...
                                        <div class="wrapper d-flex flex-column justify-content-center absolute absolute-center">
                                            ...
                                            <small class="d-block text-center text-muted  font-weight-semibold mb-0">Tổng
                                                số tài khoản</small>
                                        </div>
                                    </div>
                            ...
                            <div class="card">
                                ...
                                <div class="d-md-flex row m-0 quick-action-btns" role="group"
                                    ...
                                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
                                        <a class="btn px-0" href="/user?action=create_user"><i
                                                class="icon-user mr-2"></i>Thêm tài khoản</a>
                                    </div>
                                    <div class="col-sm-6 col-md-3 p-3 text-center btn-wrapper">
